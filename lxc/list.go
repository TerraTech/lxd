...
func (c *cmdList) baseImageAliasColumnData(cInfo api.Container, cState *api.ContainerState, cSnaps []api.ContainerSnapshot) string {
	var err error
...
func getBaseImage(cInfo api.Container, long bool) string {
...
func (c *cmdList) baseImageColumnData(cInfo api.Container, cState *api.ContainerState, cSnaps []api.ContainerSnapshot) string {
	return getBaseImage(cInfo, false)
}

func (c *cmdList) baseImageFullColumnData(cInfo api.Container, cState *api.ContainerState, cSnaps []api.ContainerSnapshot) string {
